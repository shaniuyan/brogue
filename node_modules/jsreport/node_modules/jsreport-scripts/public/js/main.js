...
;
define('scripts.list.model',['app', 'jquery', 'backbone', 'core/dataGrid', './scripts.model'], function (app, $, Backbone, DataGrid, ScriptModel) {
...
;
define('scripts.list.view',['marionette', 'jquery', 'core/dataGrid', 'core/view.base'], function (Marionette, $, DataGrid, ViewBase) {
...
;
define('scripts.template.standard.model',['app', 'jquery', 'core/basicModel', 'underscore'], function (app, $, ModelBase, _) {
  return ModelBase.extend({
...
;
define('scripts.detail.view',['marionette', 'jquery', 'core/view.base', 'core/aceBinder'], function (Marionette, $, ViewBase, aceBinder) {
  return ViewBase.extend({
