 ...
 */
define(["app",
        "tpl!apps/back_shop/mainpage/wholemanagementlist/list/table.html",
        "tpl!apps/back_shop/mainpage/wholemanagementlist/list/td.html",
        "tpl!apps/back_shop/mainpage/wholemanagementlist/list/none.html"],
    function (BrogueApplication, tableTpl, tdTpl, noneTpl) {
        BrogueApplication.module("BrogueApp.BackShop.WholesaleManagementList.ListView", function (View, BrogueApplication, Backbone, Marionette, $, _) {
            //子节点试图
        ...
        return BrogueApplication.BrogueApp.BackShop.WholesaleManagementList.ListView;
    });
