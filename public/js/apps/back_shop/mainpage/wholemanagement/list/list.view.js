 ...
 */
define(["app", "marionette", "tpl!apps/back_shop/mainpage/wholemanagement/list/list.html", "bootstrap","bootstrapvalidator","backbone.syphon"],
    function (BrogueApplication, Marionette, formTpl) {
        BrogueApplication.module("BrogueApp.BackShop.MainPage.WholeManagementList", function (SalesManagementList, BrogueApplication, Backbone, Marionette, $, _) {
        ...
        return BrogueApplication.BrogueApp.BackShop.MainPage.WholeManagementList;
    });
