 ...
 */
define(["app", "marionette", "tpl!apps/back_shop/mainpage/wholemanagement/mainform/mainform.html", "bootstrap","bootstrapvalidator","backbone.syphon"],
    function (BrogueApplication, Marionette, formTpl) {
        BrogueApplication.module("BrogueApp.BackShop.MainPage.WholeMainForm", function (SalesPrice, BrogueApplication, Backbone, Marionette, $, _) {
        ...
        return BrogueApplication.BrogueApp.BackShop.MainPage.WholeMainForm;
    });
