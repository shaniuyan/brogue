 ...
 */
define(["app", "marionette", "tpl!apps/back_shop/mainpage/wholemanagement/searchgood/layout/layout.html"],
    function (BrogueApplication, Marionette, workspaceTpl) {
        BrogueApplication.module("BrogueApp.BackShop.WholeManagement.LayoutView", function (GoodList, BrogueApplication, Backbone, Marionette, $, _) {
        ...
        return BrogueApplication.BrogueApp.BackShop.WholeManagement.LayoutView;
    });
