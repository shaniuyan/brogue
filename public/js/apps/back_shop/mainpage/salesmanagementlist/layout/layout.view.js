 ...
 */
define(["app", "marionette", "tpl!apps/back_shop/mainpage/salesmanagementlist/layout/layout.html"],
    function (BrogueApplication, Marionette, layoutTpl) {
        BrogueApplication.module("BrogueApp.BackShop.MainPage.SalesManagementListLayout", function (View, BrogueApplication, Backbone, Marionette, $, _) {
        ...
        return BrogueApplication.BrogueApp.BackShop.MainPage.SalesManagementListLayout;
    });
